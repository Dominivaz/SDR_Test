...
def main():
	...
	R22 = [const(0x002B), 0x01] # 0x04 : Best Values with V = 1.7
	R23 = [const(0x002C), 0x00]
	R24 = [const(0x002D), 0x2F]# Originally 0x0d, turned to 0x0c  0x0D : 0x0E Best Values eith V = 1.7
	R25 = [const(0x002E), 0x00]# Originally 0xA0, turned to 0x05  0xA0 : 0xE0 Best Values with V = 1.7
	...
	print('Set voltage to 1.6 V to get 10 MHz')
