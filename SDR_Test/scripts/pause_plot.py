...
df_list =     sorted(glob.glob('/home/radiopi/sync_data/sdr/pause/d_f_values' + direct), reverse=False)
dac_list =    sorted(glob.glob('/home/radiopi/sync_data/sdr/pause/dac_values' + direct), reverse=False)
unix_list =   sorted(glob.glob('/home/radiopi/sync_data/sdr/pause/unix_values' + direct), reverse=False)
