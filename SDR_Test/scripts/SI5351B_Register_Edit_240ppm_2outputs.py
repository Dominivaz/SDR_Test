...
def main():
	...
	R6 =  [const(0x0011), 0x2F] #Originally 0x8C, turned into 80
	...
	R21 = [const(0x002A), 0x00]
	R22 = [const(0x002B), 0x04] # 0x04 : Best Values with V = 1.7
	R23 = [const(0x002C), 0x00]
	R24 = [const(0x002D), 0x0E]# Originally 0x0d, turned to 0x0c  0x0D : 0x0E Best Values eith V = 1.7
	R25 = [const(0x002E), 0xE0]# Originally 0xA0, turned to 0x05  0xA0 : 0xE0 Best Values with V = 1.7
	R26 = [const(0x002F), 0x00]
	R27 = [const(0x0030), 0x00]
	R28 = [const(0x0031), 0x00]
	
	Re1 =  [const(0x0032), 0x00]
	Re2 =  [const(0x0033), 0x04]
	Re3 =  [const(0x0034), 0x00]
	Re4 =  [const(0x0035), 0x0D]
	Re5 =  [const(0x0036), 0xA0]
	...
	R38 = [const(0x00A2), 0x99]
	R39 = [const(0x00A3), 0x61]
	R40 = [const(0x00A4), 0x11]
